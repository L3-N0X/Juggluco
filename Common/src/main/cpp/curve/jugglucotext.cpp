...
.libre3wrongID={"Error, wrong account ID?",
	R"(Should be the same one used when activating the sensor. To retrieve it from LibreView, go to Left menu→Settings→Exchange data→LibreView→"Get Account ID")"},
